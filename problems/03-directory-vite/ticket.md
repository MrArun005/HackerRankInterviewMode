...
An employee directory backed by an async API, paginated.
...
> the error, empty and no-match messages, and says nothing about what the page
> number should do when the search changes. The tests do.
